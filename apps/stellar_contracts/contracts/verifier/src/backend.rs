//! Backend implementations for Soroban BN254 and Keccak operations
//!
//! This module provides the necessary backends for the UltraHonk verifier
//! to use Soroban's native cryptographic operations.

use alloc::string::String as StdString;
use soroban_sdk::{
    crypto::bn254::{Bn254G1Affine as HostG1Affine, Bn254G2Affine as HostG2Affine, Fr as HostFr},
...
/// Soroban Keccak256 backend for the UltraHonk verifier
...
/// Soroban BN254 backend for the UltraHonk verifier
