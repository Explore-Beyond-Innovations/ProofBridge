...
const mango = localFont({
  src: [
    { path: "./fonts/MangoGrotesque-Medium.ttf", weight: "500" },
    { path: "./fonts/MangoGrotesque-SemiBold.ttf", weight: "600" },
  ],
  variable: "--font-mango",
})
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body
        className={`${pixter.variable} ${sequel.variable} ${sequel.className} ${perfectlyNineties.variable} ${mango.variable} tracking-wider antialiased`}
      >
        <Wagmi>
