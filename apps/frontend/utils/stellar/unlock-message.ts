import type { ITradeParams } from "@/types/trades"
...
// `apps/backend-relayer/src/providers/stellar/utils/unlock-message.ts` — the
// backend rebuilds this string from the trade record and verifies the ed25519
// signature against its UTF-8 bytes.
export function buildStellarUnlockMessage(p: ITradeParams): string {
